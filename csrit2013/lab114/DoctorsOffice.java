...
public class DoctorsOffice {
	...
	private ArrayList<Patient> untouchedPatientList;
    ...
    public DoctorsOffice (String name) {
    	...
    	untouchedPatientList=new ArrayList<Patient>();
    }
	...
	int age) {
    	...
    	untouchedPatientList.add(newPatient);
	...
	NoSuchPatientException {
    	...
    	else
    	{
    		...
    		inactivePatients.add(untouchedPatientList.get(pos));
    		untouchedPatientList.remove(pos);
    ...
    public void listByAge() throws ClassCastException {
    
    Collections.sort(activePatients,new Comparator(){
    	...
    	Iterator<Patient> it = activePatients.iterator();
    	String listByinActive="";
    	while(it.hasNext())
    	{
    		Patient myPatient=it.next();
    		listByinActive=listByinActive + myPatient.getName() + " " + myPatient.getAge() + "\n" + "\n";
    	
    	}
    
    		System.out.println(listByinActive);
    ...
    public void listInactive() {
    	Iterator<Patient> it = inactivePatients.iterator();
    	String listByAge="";
    	while(it.hasNext())
    	{
    		Patient myPatient=it.next();
    		listByAge=listByAge + myPatient.getName() + " " + myPatient.getAge() + "\n" + "\n";
    ...
    int myNum=myDoc.addPatient("bob","tim",12);
    int myNum2=myDoc.addPatient("tom","bal",74);
    myDoc.addPatient("tom","aadl",465);
    myDoc.addPatient("tom","calsd",37);

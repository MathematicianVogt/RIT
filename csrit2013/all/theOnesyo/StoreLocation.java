...
public class StoreLocation {
	...
	/*
	 * takes 3 calculated values mean,median, and midpoint put them into a map,
	 * sort the map then print out output
	 */
	...
	public void generateStratOutput() {
		...
		System.out.println("sum of distance must travel for mean method "
				+ averageDistance);
		System.out.println("sum of distance must travel for median method "
				+ medianDistance);
		System.out.println("sum of distance must travel for midpoint method "
				+ midpointDistance);
